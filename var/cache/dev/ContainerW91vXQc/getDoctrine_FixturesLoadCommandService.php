...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ReferentielsFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/SGroupesFixtures.php';
        ...
        $c = ($container->privates['App\\Repository\\ProfilRepository'] ?? $container->load('getProfilRepositoryService'));

        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures($b, $c), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ProfilFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ReferentielsFixtures(($container->privates['App\\Repository\\GroupeCompetencesRepository'] ?? $container->load('getGroupeCompetencesRepositoryService'))), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\SGroupesFixtures($b, $c, ($container->privates['App\\Repository\\ReferentielsRepository'] ?? $container->load('getReferentielsRepositoryService')), ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService'))), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UserFixtures($b), 'groups' => []]]);
